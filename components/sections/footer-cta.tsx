        ...
        <section className="relative py-12 bg-transparent overflow-hidden">
            <div className="container mx-auto px-6">
                <motion.div
                    ...
                    className="relative w-full max-w-7xl mx-auto rounded-[2.5rem] overflow-hidden bg-linear-to-br from-cyan-200/60 via-white to-orange-200/60 dark:from-cyan-950/40 dark:via-zinc-900 dark:to-orange-950/40 p-8 md:p-12 text-center border border-zinc-200 dark:border-zinc-800"
                >
                    ...
                    <div className="relative z-10 max-w-4xl mx-auto space-y-5">
                        ...
                        >
                            Innovative solutions for <span className="italic font-serif font-normal text-zinc-700/80 dark:text-zinc-300">bold brands</span>
                        </motion.h2>
